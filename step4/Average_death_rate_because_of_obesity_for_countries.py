...
query = "SELECT c.C_Name, AVG(ob.death_rate) AS avg_deathrate" + " FROM obesity_report ob,countries c" + " WHERE c.C_Code = ob.C_Code and ob.YYear BETWEEN 2000 AND 2010"+" GROUP BY C_Name" + " ORDER BY avg_deathrate ASC"
